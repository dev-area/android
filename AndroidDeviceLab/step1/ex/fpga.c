...
{
    // TODO: map the PHY_MAP_ADD to the user
}
...
static irqreturn_t *irq_handle(void * dev_id)
{
    ...
    regs[4]=1; //clear the current Interrupt
    flag = 1; // wake up the waiting process
    wake_up(&hq);
    return 0;
}
...
hello_init (void)
{
    // TODO: register to irq=6
    // TODO: map the physical address to the kernel
